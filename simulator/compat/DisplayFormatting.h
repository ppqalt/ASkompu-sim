...
// Desktopin esitysmuotoilusovitin. Perustuu v0.2.5:n yhteiseen DisplayFormatting-
// otsakkeeseen; vanhan upstreamin DisplayView.cpp pitää nämä apurit yksityisinä.
// Ei kilpailu-, aika-, reitti- tai pulssilaskentaa. Valittua lähdepuuta ei muuteta.
