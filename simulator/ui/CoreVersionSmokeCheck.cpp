...
void CoreVersionSmokeCheck::beforeFrame(SimulatorView& view,SDL_Window* window){
  ...
  switch(step_){
    ...
    case 1:if(view.corePhase()=="done")advance();else if(view.corePhase()=="failed")throw std::runtime_error("Versionvalitsimen työkalutarkistus epäonnistui");break;
    case 2:if(click(view,"Päivitä versiolista"))advance();break;
    case 3:if(view.corePhase()=="done"){capture_="ytimen-versiot.bmp";advance();}else if(view.corePhase()=="failed")throw std::runtime_error("Versionvalitsimen versiolistan haku epäonnistui");break;
    case 4:SDL_SetWindowSize(window,780,660);advance();break;
    case 5:capture_="ytimen-versiot-pieni.bmp";advance();break;
    case 6:if(click(view,"Ratkaise SHA"))advance();break;
    case 7:if(view.corePhase()=="failed"){capture_="ytimen-versiot-virhe.bmp";advance();}break;
    case 8:
    ...
    case 9:if(click(view,"Rakenna valittu ydin"))advance();break;
    case 10:if(view.corePhase()=="building"){capture_="ytimen-rakennus.bmp";advance();}else if(view.corePhase()=="failed")throw std::runtime_error("Valitsimen oikea rakennus epäonnistui ennen peruutustestiä");break;
    case 11:if(click(view,"Peruuta toiminto"))advance();break;
    case 12:if(view.corePhase()=="cancelled")advance();break;
    case 13:if(click(view,"Rakenna valittu ydin"))advance();break;
    case 14:if(view.corePhase()=="ready"){capture_="ytimen-rakennus-valmis.bmp";advance();}else if(view.corePhase()=="failed")throw std::runtime_error("Valitsimen oikea rakennus tai testit epäonnistuivat");break;
    case 15:if(click(view,"Käynnistä uudelleen"))advance();break;
    case 16:if(click(view,"Aloita uusi sessio"))advance();break;
    case 17:if(view.restartCompleted()){finished_=true;std::cout<<"Hyväksytty: ytimen GUI-rakennus, peruutus, testit ja oikea uudelleenkäynnistys\n";}else if(view.corePhase()=="failed")throw std::runtime_error("Uuden simulaattorin käynnistys epäonnistui");break;
  }
}
