...
if(ASKOMPU_USE_SYSTEM_SDL)
  ...
  install(FILES "${sdl_SOURCE_DIR}/LICENSE.txt"
    DESTINATION share/askompu-simulaattori RENAME SDL-LICENSE.txt)
endif()
...
string(REGEX REPLACE "(..)" "0x\\1," ASKOMPU_FONT_BYTES "${ASKOMPU_FONT_HEX}")
file(MAKE_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/generated")
file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/generated/EmbeddedFont.h"
  "#pragma once\nstatic const unsigned char embeddedFont[] = {${ASKOMPU_FONT_BYTES}};\n")
